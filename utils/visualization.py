...
if __name__ == '__main__':
    ...
    default_files = check_processed_file(os.listdir('../new_data/new_mouse_data'), '../new_data/new_draw_path/default')
    union_files = check_processed_file(os.listdir('../new_data/new_mouse_union'), '../new_data/new_draw_path/union')

    print('Обрабатываемые файлы: ', default_files)

    for file in default_files:
        create_picture(file, '../new_data/new_mouse_data', 'new_data/new_draw_path/default')

    for file in union_files:
        create_picture(file, '../new_data/new_mouse_union', 'new_data/new_draw_path/union')
